    ...
    window.addEventListener("load", function () {
        ...
        function showAllCards() {
            ...
            for (let c = 0; c < computerCards.length; c++) {
                let cardImage = imgGeneratCards("card-back");
        ...
        //Karte erzeugen 
        function imgGeneratCards(kartenName) {
        ...
        function cardFits(kartenName) {
            let openCardsplit = openCards[openCards.length - 1].split("-");
            let cardNameSplit = kartenName.split("-");
            let valueOk = openCardsplit[0] === cardNameSplit[0];
            let colorOk = openCardsplit[1] === cardNameSplit[1];
